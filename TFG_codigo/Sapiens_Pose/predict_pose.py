...
from adhoc_image_dataset import AdhocImageDataset # type: ignore
from classes_and_palettes import ( # type: ignore
    COCO_KPTS_COLORS,
...
from pose_utils import nms, top_down_affine_transform, udp_decode # type: ignore
...
try:
    ...
    from mmdet.structures import DetDataSample, SampleList # type: ignore
    from mmdet.utils import get_test_pipeline_cfg # type: ignore
...
def main():
    ...
    # limitamos threads para evitar oversubscription
    os.environ["OMP_NUM_THREADS"] = "1"
    os.environ["MKL_NUM_THREADS"] = "1"
    torch.set_num_threads(1)

    # usar spawn evita problemas de fork+cuda deadlocks
    ...
    if args.det_config is None or args.det_config == "":
        ...
        from detector_utils import ( # type: ignore
    ...
    batch_size=args.batch_size,
    shuffle=False,
    num_workers=0,  # <- temporalmente 0 para descartar problemas de workers
    )
