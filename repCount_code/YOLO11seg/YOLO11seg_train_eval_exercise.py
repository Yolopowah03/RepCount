...
DATASET_PATH = "/datatmp2/joan/repCount/exercise_dataset_seg/exercise_dataset_seg.yaml"

MODEL_PATH = '/datatmp2/joan/repCount/models_exercise_seg/yolo11m-seg.pt'

MODEL_NEW_PATH = '/datatmp2/joan/repCount/models_exercise_seg/YOLO11seg_exercise_batch1.pt'

TMP_DIR = '/datatmp2/joan/repCount/models_exercise_seg'
