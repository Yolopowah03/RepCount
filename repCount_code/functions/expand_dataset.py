...
dir_imgs = '/datatmp2/joan/repCount/images_to_train/Squat1/images/Train'
dir_labels = '/datatmp2/joan/repCount/images_to_train/Squat1/labels/Train'
out_dir_images_train = '/datatmp2/joan/repCount/exercise_dataset_seg/train/images'
out_dir_labels_train = '/datatmp2/joan/repCount/exercise_dataset_seg/train/labels'
out_dir_images_test = '/datatmp2/joan/repCount/exercise_dataset_seg/test/images'
out_dir_labels_test = '/datatmp2/joan/repCount/exercise_dataset_seg/test/labels'
