...
MODEL_PATH = '/datatmp2/joan/repCount/models_LSTM/LSTM_17_RepCount1.pth'
PREDICT_DIR = '/datatmp2/joan/repCount/LSTM_dataset/test/labels'
CM_SAVE_PATH = '/datatmp2/joan/repCount/results/LSTM/confusion_matrix_LSTM_17_RepCount1.png'
...
def predict_video(video_coords, model, device, class_names=None, seq_len=SEQ_LEN):
...
if __name__ == "__main__":
    ...
    if VEL == False:
        input_size = N_KEYPOINTS * 2
    else:
        input_size = N_KEYPOINTS * 2 * 2  # Posició + Velocitat
