...
CONDA_ENV_NAME="sapiens_lite"
SAPIENS_ROOT="/datatmp2/joan/tfg_joan/sapiens"
...
INPUT_ROOT='/datatmp2/joan/tfg_joan/LSTM_dataset/images/pull_up'
OUTPUT_ROOT="/datatmp2/joan/tfg_joan/LSTM_dataset/labels/pull_up"
