...
INPUT='/datatmp2/joan/tfg_joan/images/test/pull_up_1'
OUTPUT="/datatmp2/joan/tfg_joan/results/test_pull_up_1"
...
MODEL_NAME='sapiens_1b'; CHECKPOINT=/datatmp2/joan/tfg_joan/sapiens/sapiens_lite_host/torchscript/pose/checkpoints/sapiens_1b/sapiens_1b_coco_best_coco_AP_821_torchscript.pt2
