...
MODEL_PATH = '/datatmp2/joan/tfg_joan/models_YOLO11_pose/yolo11m-pose.pt'
INPUT_DIR = '/datatmp2/joan/tfg_joan/LSTM_dataset/test/images/bench_press'
OUTPUT_DIR = '/datatmp2/joan/tfg_joan/LSTM_dataset/test/labels/bench_press'
